      ...
      projects: [
        {
          ...
          description: 'A comprehensive project management tool with TypeScript and Next.js, featuring real-time updates and team collaboration.',
        ...
        },
        {
          ...
          description: 'A modern UI component library built with TypeScript and React, featuring fully typed props and comprehensive documentation.',
        ...
        },
        {
          ...
          description: 'An analytics platform built with TypeScript, providing real-time data visualization and custom reporting features.',
          image: 'https://images.unsplash.com/photo-1551288049-bebda1b704d3?q=80&w=2070&auto=format&fit=crop',
    ...
    },
    {
      ...
      projects: [
        ...
        },
        {
          ...
          description: 'A beautiful weather application built with React that shows current weather and forecasts for any location worldwide.',
        ...
        },
        {
          ...
          description: 'A comprehensive task management application with features like drag-and-drop, categories, and real-time updates.',
      ...
      projects: [
        {
          ...
          description: 'A robust API gateway service that handles authentication, rate limiting, and request routing for microservices architecture.',
        ...
        },
        {
          ...
          description: 'A scalable real-time chat system built with Node.js and Socket.io, supporting private messages and group chats.',
        ...
        },
        {
          ...
          description: 'A complete e-commerce backend system with product management, user authentication, and order processing.',
      ...
      projects: [
        {
          ...
          description: 'A modern e-learning platform with course management, video streaming, and interactive quizzes.',
        ...
        {
          title: 'Blog Platform',
          description: 'A full-featured blog platform with MDX support, comments, and social sharing.',
        ...
        },
        {
          ...
          description: 'A tool for developers to create beautiful portfolios with custom themes and content management.',
                ...
                return (
                  ...
                  >
                    <div className={`md:grid md:grid-cols-12 md:gap-8 items-center 
                                  ${isRight ? '' : 'text-right'}`}>
                      <div className={`relative md:col-span-7 mb-8 md:mb-0
                      ...
                      <div className={`relative md:col-span-7 
                                    ${isRight ? 'md:col-start-6' : 'md:col-start-1'}`}>
                        <div>
                          ...
                          <ul className={`flex flex-wrap gap-2.5 mb-8 font-mono text-sm 
                                       ${!isRight ? 'justify-end' : ''}`}>
